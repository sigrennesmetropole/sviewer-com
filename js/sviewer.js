...
'</gml:pos> \
   ...
   function setTitle(title) {
    ...
    function doMap() {
		...
		marker.setPosition([config.x, config.y]);
        $('#marker').show();
    }
    ...
    function doGUI() {
		...
		if(window.location.search.indexOf("permalink") !== -1) {
			$("#panelPoiBtn").remove();
			$("#panelShareBtn").removeClass("ui-icon-edit")
				.removeClass("ui-btn-icon-right");
			$("#panelShareBtn").attr("href",window.location);
		}
